...
public class OptionMenu extends Account {
	...
	public void getLogin() throws IOException {
		...
		do {
			try {
				...
				data.put(7891011, 7894);
				System.out.println("Welcome to JIS ATM.\n");
	...
	public void getAccountType() {
		...
		case 3:
			System.out.println("Thank you for using JIS ATM.");
			break;
	...
	public double getChecking() {
		...
		case 3:
			...
			break;
		case 4:
			System.out.println("Thank you for using JIS ATM, bye");
			break;
		default:
			System.out.println("\n" + "Invalid Choice" + "\n");
			getChecking();
